...
class Header extends React.Component  {
  ...
  <a className="navbar-brand" href="/">GreatappersJS</a>
  ...
  <div className="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li className="d-flex justify-content-center align-items-center ml-3">
    <a className="nav-link" href="/registro" id="navbarDropdown">
          Registro
